...
const TransformsWellness = () => {
    return (
        <div className='xl:pt-[97px] lg:pt-[60px] md:pt-[50px] pt-[40px] xl:pb-[170px] lg:pb-[100px] md:pb-[70px] sm:pb-[50px] pb-[40px] relative '>
            <img src={dottedline} alt="dottedline" className='max-w-[85px] w-full z-0 absolute bottom-[16%] left-[7%]' />
            <img src={greencircle} alt="dottedline" className='max-w-[27px] w-full z-0 absolute bottom-[10%] left-[4%]' />
            <div className='container xl:max-w-[1164px] px-3 mx-auto relative'>
                ...
                <div className='flex lg:flex-row flex-col-reverse flex-wrap justify-between xl:mb-[84px] lg:mb-[50px] sm:mb-[30px] mb-[20px]'>
                    <div className='xl:max-w-[498px] mt-[20px] sm:mt-[30px] lg:mt-0 lg:max-w-[480px] min-h-[289px] w-full h-full p-[20px] sm:p-[24px] border-[1px] border-solid border-lightgrey rounded-[16px] relative' data-aos="fade-right">
                ...
                <div className='flex lg:flex-row flex-col flex-wrap justify-between xl:mb-[84px] lg:mb-[50px] sm:mb-[30px] mb-[20px]'>
                    ...
                    <div className='xl:max-w-[498px] mt-[20px] sm:mt-[30px] lg:mt-0 lg:max-w-[480px] min-h-[289px] w-full h-full p-[20px] sm:p-[24px] border-[1px] border-solid border-lightgrey rounded-[16px] relative' data-aos="fade-left">
                ...
                <div className='flex lg:flex-row flex-col-reverse flex-wrap justify-between '>
                    <div className='xl:max-w-[498px] bg-white z-[2] mt-[20px] sm:mt-[30px] lg:mt-0 lg:max-w-[480px] min-h-[289px] w-full h-full p-[20px] sm:p-[24px] border-[1px] border-solid border-lightgrey rounded-[16px] relative' data-aos="fade-right">
